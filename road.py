...
class road:
    def __init__(self,car_speed,lanes,arc_len,lane_width,max_y):
        self.buffers = []
        ...
        self.__create_shaders(car_speed,lanes,arc_len,lane_width,max_y)
    ...
    def __create_shaders(self,car_speed,lanes,arc_len,lane_width,max_y):
